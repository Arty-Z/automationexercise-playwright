...
export class SignUpPage extends BasePage{
    ...
    constructor(page: Page) {
        ...
        this.enterAccountInfoTitle = page.getByText('Enter Account Information');
    ...
    async validateEnterAccountInfoTitle(): Promise<void> {
        await this.enterAccountInfoTitle.isVisible();
    ...
    async fillAddressDetails(firstName: string, lastName: string, company: string, address1: string, address2: string, country: string, state: string, city: string, zipcode: string, mobileNumber: string): Promise<void> {
